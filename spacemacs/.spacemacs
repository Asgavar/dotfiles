...
`dotspacemacs/user-config' first."
  (setq-default dotspacemacs-themes '(gruvbox-dark-hard arjen-grey solarized-light afternoon flatland zerodark badwolf birds-of-paradise-plus))
